...
public class TradeService {
    ...
    public Trade createTrade(String initiatorId, String receiverId, Resource offeredResources, List<Item> offeredItems,
        ...
        GameState initiatorState = storageService.loadGameState(initiatorId);
        GameState receiverState = storageService.loadGameState(receiverId);
    ...
    public Trade acceptTrade(String playerId, String tradeId) throws IOException {
        GameState receiverState = storageService.loadGameState(playerId);
